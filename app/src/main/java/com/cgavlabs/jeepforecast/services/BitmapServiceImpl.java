...
public class BitmapServiceImpl implements BitmapService {
    ...
    @Override
    public Single<Bitmap> scaleAndRotateBitmap(final String imgPath, final int maxImgSize) {
    ...
    @Override
    public Single<Bitmap> scaleAndRotateBitmap(final Uri imgUri, final int maxImgSize) {
        return Single.fromCallable(() -> {
